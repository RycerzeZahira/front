...
public class SignupActivity extends AppCompatActivity {
    ...
    @BindView(lodzka.politechnika.qrcode.R.id.input_name) EditText _firstName;
    @BindView(lodzka.politechnika.qrcode.R.id.input_address) EditText _lastName;
    ...
    @BindView(lodzka.politechnika.qrcode.R.id.input_reEnterPassword) EditText _reEnterPasswordText;
    @BindView(lodzka.politechnika.qrcode.R.id.btn_signup) Button _signupButton;
    @BindView(lodzka.politechnika.qrcode.R.id.link_login) TextView _loginLink;
